...
},
{
  "id": 42,
  "name": "Midjourney",
  "description": "AI-powered image generation tool that creates artwork from text descriptions.",
...
},
{
  ...
  "description": "Open-source AI image generation model for creating visual content.",
...
},
{
  "id": 44,
  "name": "DALL-E 3",
  "description": "OpenAI's advanced image generation system for creating detailed images from text.",
...
},
{
  "id": 45,
  "name": "ChatGPT",
  "description": "AI language model for conversation, content creation, and problem solving.",
...
},
{
  "id": 47,
  "name": "GrammarlyGO",
  "description": "AI writing assistant that helps refine tone, clarity, and effectiveness of communication.",
  "website": "https://www.grammarly.com/grammarlygo",
  "category": "Productivity & Writing",
  "logo": "/images/47.png"
},
{
  ...
  "description": "AI-powered writing tool that improves readability and clarity of text.",
...
},
{
  "id": 49,
  "name": "Quillbot",
  "description": "AI paraphrasing tool that helps rewrite and enhance writing quality.",
...
},
{
  "id": 50,
  "name": "CopySmith",
  "description": "AI content generator for product descriptions, ads, and marketing copy.",
...
},
{
  "id": 51,
  "name": "Writer",
  "description": "AI writing platform for businesses to create consistent, on-brand content.",
...
},
{
  "id": 52,
  "name": "Sudowrite",
  "description": "AI writing assistant specifically designed for fiction writers and novelists.",
...
},
{
  "id": 53,
  "name": "Jasper Chat",
  "description": "Conversational AI interface for content creation and idea generation.",
...
},
{
  "id": 54,
  "name": "Anyword",
  "description": "AI copywriting platform that predicts performance of marketing content.",
...
},
{
  "id": 55,
  "name": "Writesonic",
  "description": "AI content creator for blogs, ads, emails, and website copy.",
...
},
{
  "id": 56,
  "name": "Rytr",
  "description": "AI writing assistant that generates content for various purposes and tones.",
...
},
{
  "id": 57,
  "name": "Wordtune",
  "description": "AI writing companion that rewrites sentences for clarity and impact.",
...
},
{
  "id": 60,
  "name": "Hypotenuse AI",
  "description": "AI content writer that creates SEO-optimized articles and product descriptions.",
...
},
{
  "id": 61,
  "name": "INK Editor",
  "description": "AI-powered content optimization platform for SEO and reader engagement.",
...
},
{
  "id": 62,
  "name": "Frase",
  "description": "AI content research and optimization tool for SEO-focused writing.",
...
},
{
  "id": 63,
  "name": "Scalenut",
  "description": "AI-powered content research and writing platform for SEO content.",
...
},
{
  "id": 65,
  "name": "Longshot AI",
  "description": "AI writing assistant specialized in creating long-form content and blogs.",
...
},
{
  "id": 67,
  "name": "Narrato",
  "description": "AI-powered content workspace for planning, creating, and optimizing content.",
...
},
{
  "id": 68,
  "name": "TextCortex",
  "description": "AI writing assistant that helps create various types of content.",
...
},
{
  "id": 69,
  "name": "WordAI",
  "description": "AI text spinner that creates human-quality content rewrites.",
...
},
{
  "id": 71,
  "name": "Article Forge",
  "description": "AI content generator that researches and writes articles automatically.",
...
},
{
  "id": 72,
  "name": "AI Writer",
  "description": "Content generation platform that creates articles from headlines.",
